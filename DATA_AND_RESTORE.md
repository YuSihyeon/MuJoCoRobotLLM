...
원본 영상은 `MuJoCo_test1.mp4`, `MuJoCo_test2.mp4`, `로봇팔Mujoco_수동제어.mp4`, `로봇팔Mujoco_명령제어.mp4`, `로봇팔Mujoco_llm.mp4`다. 공개 갤러리의 미리보기·프레임 추출물과 구분해 원래 이름과 바이트를 유지한다. LLM 영상 초반의 계획 검증 모드는 로봇을 움직이지 않으며, 후반의 실제 Panda 제어와 구분한다.
